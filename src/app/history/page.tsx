...
import { formatAmount, displayValue, unitLabel } from "@/lib/units";
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            {selectedDay ? (
              <div className="space-y-4">
                <button
                  ...
                  className="text-blue-500 font-medium flex items-center gap-1 text-sm"
                >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    ...
                    <span>Score: <span className={selectedDay.score.color}>{selectedDay.score.total}</span></span>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-right">
                        <p className={`text-lg font-bold ${day.score.color}`}>{day.score.total}</p>
                        <p className="text-xs text-gray-400">{day.score.label}</p>
                      </div>
                      {day.goalMet && <span className="text-green-500">✓</span>}
                    </div>
                  </button>
                ))}
              </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800 safe-area-pb">
        <div className="max-w-lg mx-auto flex">
          ...
          <Link href="/history" className="flex-1 py-3 flex flex-col items-center text-blue-500">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
